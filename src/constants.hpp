...
const uint32_t PERIPHERAL_PIN_SEVEN_SEGMENT_C = 20;
const uint32_t PERIPHERAL_PIN_SEVEN_SEGMENT_D = 19;
const uint32_t PERIPHERAL_PIN_SEVEN_SEGMENT_E = 18;
const uint32_t PERIPHERAL_PIN_SEVEN_SEGMENT_F = 15;
const uint32_t PERIPHERAL_PIN_SEVEN_SEGMENT_G = 14;
...
const uint32_t MAIN_PIN_ACTIVE_COOLING_SWITCH = 22;
const uint32_t MAIN_PIN_MANUAL_AUTOMATIC_CONTROL_SWITCH = 21;
